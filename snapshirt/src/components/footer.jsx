      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-10">
        <div className="flex gap-20">
          <div>
            <div className='pt-2 flex flex-col items-center'>
                  <img src={tshirt} className='rounded-2xl overflow-hidden w-20 h-20' alt="T-shirt logo" />
            ...
            <ul className="mt-8 flex justify-center items-center gap-6  md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-bleck transition hover:text-[#9b9b9bee]"
                >
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 Snapshirt</p>
          </div>
        </div>
      </div>
    </footer>
